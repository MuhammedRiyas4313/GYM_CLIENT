                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        ...
                        Are you sure you want to cancel your membership? Please note that cancellation may result in missing your slot and we will not be able to refund your fee. If it's been more than a week, only a partial refund will be given due to a minimum charge reduction.                         </p>
                      </div>
                    </div>
                  </div>
                </div>
